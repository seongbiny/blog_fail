...
class SourceFetchDataError extends Tagged('SourceFetchDataError') {
    constructor() {
        super(...arguments);
...
export { SourceFetchDataError };
export const isSourceFetchDataError = (_) => _.hasOwnProperty('_tag') && _._tag === 'SourceFetchDataError';
class SourceProvideSchemaError extends Tagged('SourceProvideSchemaError') {
    constructor() {
        super(...arguments);
...
export { SourceProvideSchemaError };
/**
