...
export declare namespace ArtifactsDir {
    ...
    const mkdir: T.Effect<OT.HasTracer & HasCwd & fs.HasFs, fs.MkdirError, AbsolutePosixFilePath>;
    const getCacheDirPath: T.Effect<OT.HasTracer & HasCwd & fs.HasFs, GetContentlayerVersionError, AbsolutePosixFilePath>;
    const mkdirCache: T.Effect<OT.HasTracer & HasCwd & fs.HasFs, fs.MkdirError | GetContentlayerVersionError, AbsolutePosixFilePath>;
}
