...
export const processArgs = async (argsOrArgsThunk, sourceKey) => {
    const { extensions, fieldOptions, markdown, mdx, date, disableImportAliasWarning, experimental, ...restArgs } = typeof argsOrArgsThunk === 'function' ? await argsOrArgsThunk(sourceKey) : argsOrArgsThunk;
    const options = {
        markdown,
        mdx,
        date,
